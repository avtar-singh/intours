...
const displayMap = locations => {
  var map = new maplibregl.Map({
    container: 'map',
    style: 'https://api.maptiler.com/maps/streets/style.json?key=zQbBWTl7eEF6Cn0YJNq1',
    antialias: true,
    scrollZoom: false
  });
...
const stripe = Stripe('pk_test_51MxkdeSHesHCrXaumYtjHwkGxqHoMKjjwTcSJmDn7KasotusJ0xcxcc4EOAWg6hMzdxvEuOwNPBhkRcQCCfb8LfU00BFm97Ir9');
